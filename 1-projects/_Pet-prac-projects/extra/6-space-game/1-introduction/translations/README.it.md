...
Un modo diverso di gestire l'ereditarietà degli oggetti consiste nell'usare la _composizione_. Con questo sistema gli oggetti esprimono il loro comportamento in questo modo:
...
- **publisher**: questo elemento _pubblica_ un messaggio e lo invia a tutti i sottoscrittori.
- **subscriber**: questo elemento _ascolta_ messaggi specifici e svolge alcune attività come risultato della ricezione di questo messaggio, come sparare con un laser.
