...
document.getElementById("nickname").innerHTML =
  'JavaScript says it\'s, "mixelpix."';
// 5. Add your favorites
document.getElementById("favorites").innerHTML =
  "JavaScript says it's, \"Korean food, my dog 'Lucy' & philosophy.\"";
// 6. Add your hometown
document.getElementById("hometown").innerHTML =
  'JavaScript says it\'s, "Kailua, HI."';
...
image.setAttribute(
  "alt",
  "JavaScript says, \"it's Lucy wearing mixelpix's gardening hat!\""
);
