...
Knight.prototype.getMovePaths = function() {
    ...
    move1 = {row: this.currentPosition.row - 1, column: this.currentPosition.column + 2};
    ...
    move2 = {row: this.currentPosition.row - 2, column: this.currentPosition.column + 1};
    ...
    move3 = {row: this.currentPosition.row-2, column: this.currentPosition.column-1};
    ...
    move4 = {row: this.currentPosition.row-1, column: this.currentPosition.column-2};
    ...
    move5 = {row: this.currentPosition.row+1, column: this.currentPosition.column-2};
    ...
    move6 = {row: this.currentPosition.row+2, column: this.currentPosition.column-1};
    ...
    move7 = {row: this.currentPosition.row+2, column: this.currentPosition.column+1};
    ...
    move8 = {row: this.currentPosition.row+1, column: this.currentPosition.column+2};
