...
UIcompositionChanged.fn = new Map([
  [
    ...
    function (obj) {
      const synOpenedChan =
          obj.channels[DAW.get.synth(DAW.get.synthOpened()).dest],
  ...
  [
    ...
    function ({ bpm }) {
      ...
      DOM.bpm.textContent = UIcompositions.get(DAW.get.cmp()).bpm.textContent =
        bpm;
  ...
  [
    ...
    function ({ name }) {
      UItitle(name);
      DOM.headCmpName.textContent = UIcompositions.get(
        DAW.get.cmp()
  ...
  [
    ...
    function ({ duration }) {
      ...
      DOM.headCmpDur.textContent = UIcompositions.get(
        DAW.get.cmp()
  ...
  [
    ...
    function (obj) {
      if (obj.synthOpened) {
        ...
        DOM.synthChannelBtn.onclick = UImixerOpenChanPopup.bind(
          null,
          obj.synthOpened
        );
