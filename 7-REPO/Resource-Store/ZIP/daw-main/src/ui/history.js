...
function UIhistoryInit() {
  DAW.cb.historyUndo = (act) =>
    UIhistoryActions.get(act.index).classList.add("historyAction-undone");
  DAW.cb.historyRedo = (act) =>
    UIhistoryActions.get(act.index).classList.remove("historyAction-undone");
