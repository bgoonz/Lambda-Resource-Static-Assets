module.exports = (() => {
  ...
  var e = {
    ...
    206: (e, t, i) => {
      ...
      t.default = loader
      t.raw = void 0
      var r = _interopRequireDefault(i(622))
      var o = _interopRequireDefault(i(443))
      var a = _interopRequireDefault(i(225))
      var n = _interopRequireDefault(i(764))
      function _interopRequireDefault(e) {
        return e && e.__esModule ? e : { default: e }
      }
      function loader(e) {
        const t = o.default.getOptions(this)
        ;(0, a.default)(n.default, t, {
          name: 'File Loader',
          baseDataPath: 'options',
        })
        const i = t.context || this.rootContext
        const s = o.default.interpolateName(
          this,
          t.name || '[contenthash].[ext]',
          { context: i, content: e, regExp: t.regExp }
        )
        let p = s
        if (t.outputPath) {
          if (typeof t.outputPath === 'function') {
            p = t.outputPath(s, this.resourcePath, i)
          } else {
            p = r.default.posix.join(t.outputPath, s)
          }
        }
        let u = `__webpack_public_path__ + ${JSON.stringify(p)}`
        if (t.publicPath) {
          if (typeof t.publicPath === 'function') {
            u = t.publicPath(s, this.resourcePath, i)
          } else {
            u = `${
              t.publicPath.endsWith('/') ? t.publicPath : `${t.publicPath}/`
            }${s}`
          }
          u = JSON.stringify(u)
        }
        if (t.postTransformPublicPath) {
          u = t.postTransformPublicPath(u)
        }
        if (typeof t.emitFile === 'undefined' || t.emitFile) {
          this.emitFile(p, e)
        }
        const l = typeof t.esModule !== 'undefined' ? t.esModule : true
        return `${l ? 'export default' : 'module.exports ='} ${u};`
      }
      const s = true
      t.raw = s
    },
