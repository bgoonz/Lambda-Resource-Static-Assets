module.exports = (() => {
  var e = {
    ...
    526: (e) => {
      ...
      function format(e, s) {
        ...
        var o = Math.abs(e)
        var c = (s && s.thousandsSeparator) || ''
        var t = (s && s.unitSeparator) || ''
        var p = s && s.decimalPlaces !== undefined ? s.decimalPlaces : 2
        var r = Boolean(s && s.fixedDecimals)
        var l = (s && s.unit) || ''
  ...
  function __nccwpck_require__(i) {
    ...
    var s = true
    try {
      e[i](n, n.exports, __nccwpck_require__)
      s = false
    } finally {
      if (s) delete a[i]
    }
