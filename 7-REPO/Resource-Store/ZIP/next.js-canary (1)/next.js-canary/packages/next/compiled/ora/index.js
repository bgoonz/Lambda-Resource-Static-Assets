module.exports = (() => {
  var e = {
        ...
        function clone(e, t, r, s) {
          ...
          function _clone(e, r) {
            ...
            for (var u in e) {
              var f
              if (_) {
                f = Object.getOwnPropertyDescriptor(_, u)
              }
              if (f && f.set == null) {
                continue
              }
    ...
    970: (e, t, r) => {
      ...
      const f = r(3)
      const c = Symbol('text')
      const p = Symbol('prefixText')
      const h = 3
      class StdinDiscarder {
        constructor() {
          this.requests = 0
          this.mutedStream = new f()
      ...
      class Ora {
        ...
        updateLineCount() {
          ...
          const t = typeof this[p] === 'string' ? this[p] + '-' : ''
          this.lineCount = _(t + '--' + this[c])
            .split('\n')
            .reduce((t, r) => {
              return t + Math.max(1, Math.ceil(l(r) / e))
            }, 0)
        }
        set text(e) {
          this[c] = e
