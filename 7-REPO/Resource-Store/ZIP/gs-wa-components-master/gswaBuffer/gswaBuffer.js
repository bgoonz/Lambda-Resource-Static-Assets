...
window.gswaBuffer = function () {
  this.ABSNs = {};
  this.ABSNsLength = this._currId = 0;
};
...
gswaBuffer.prototype = {
  ...
  load(data) {
    return data instanceof AudioBuffer
      ? Promise.resolve(this._setDataFromAudioBuffer(data))
      : data instanceof ArrayBuffer
      ? this._setDataFromArrayBuffer(data)
      : data instanceof Blob
      ? this._setDataFromBlob(data)
