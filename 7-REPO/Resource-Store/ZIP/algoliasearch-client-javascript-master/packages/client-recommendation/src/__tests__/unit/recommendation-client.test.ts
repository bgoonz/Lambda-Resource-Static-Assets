...
describe('personalization', () => {
  ...
  it('set personalization strategy', async () => {
    ...
    const setPersonalizationStrategyResponse =
      await recommendationClient.setPersonalizationStrategy(personalizationStrategy, {
        foo: 'bar',
      });
  ...
  it('get personalization strategy', async () => {
    ...
    const getPersonalizationStrategyResponse =
      await recommendationClient.getPersonalizationStrategy();
