...
class GSPatternroll {
  constructor() {
      ...
      dataBlocks = new DAWCore.controllers.blocks({
        dataCallbacks: {
          ...
          changeBlockProp: (id, prop, val) =>
            uiPatternroll.changeBlockProp(id, prop, val),
          updateBlockViewBox: (id, blc) =>
            uiPatternroll.updateBlockViewBox(id, blc),
        },
      });
    ...
    this._dawcore = this._svgForms = null;
    Object.seal(this);
  ...
  _onchange(obj, ...args) {
    switch (
      ...
      case "add":
        this._dawcore.callAction("addBlock", ...args);
        break;
      case "move":
        this._dawcore.callAction("moveBlocks", ...args);
        break;
      case "cropEnd":
        this._dawcore.callAction("cropEndBlocks", ...args);
        break;
      case "cropStart":
        this._dawcore.callAction("cropStartBlocks", ...args);
        break;
      case "duplicate":
        this._dawcore.callAction("duplicateSelectedBlocks", ...args);
        break;
      case "deletion":
        this._dawcore.callAction("removeBlocks", ...args);
        break;
      case "selection":
        this._dawcore.callAction("selectBlocks", ...args);
        break;
      case "unselection":
        this._dawcore.callAction("unselectAllBlocks", ...args);
        break;
      case "unselectionOne":
        this._dawcore.callAction("unselectBlock", ...args);
        break;
    }
  }
  _oneditBlock(_id, obj, blc) {
    if (blc._gsuiSVGform) {
      ...
      this._svgForms[pat.type].setSVGViewbox(
        blc._gsuiSVGform,
        obj.offset,
        obj.duration,
        this._dawcore.get.bpm() / 60
      );
    }
  }
