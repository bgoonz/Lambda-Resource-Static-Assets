...
DAWCore.json.composition = (env, id) => {
  ...
  return {
    ...
    buffers: {
      0: { type: "audio/wav", duration: 0.1529, url: "kick-00.wav" },
      1: { type: "audio/wav", duration: 0.256, url: "clap-00.wav" },
      2: { type: "audio/wav", duration: 0.0357, url: "hat-00.wav" },
      3: { type: "audio/wav", duration: 0.1151, url: "snare-00.wav" },
      4: { type: "audio/wav", duration: 0.7, url: "hat-open-00.wav" },
    },
    patterns: {
      0: {
        order: 0,
