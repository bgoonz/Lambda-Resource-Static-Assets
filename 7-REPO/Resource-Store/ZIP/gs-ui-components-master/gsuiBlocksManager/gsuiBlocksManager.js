...
class gsuiBlocksManager {
  constructor(opts) {
    ...
    this.__fontSize = this.__pxPerBeat = 10;
    this.__blcs = new Map();
  ...
  // ............................................................................................
  __getRow0BCR() {
    return this.__rows[0].getBoundingClientRect();
  }
  __getRowByIndex(ind) {
    return this.__rows[ind];
  }
  __getRowIndexByRow(row) {
    return Array.prototype.indexOf.call(this.__rows, row);
  }
  ...
  __getBeatSnap() {
    return (
      (1 / this.timeline.stepsPerBeat) * this.timeline.getAttribute("step")
    );
  }
  __eventReset() {
    this.__mmFn = this.__valueA = this.__valueB = null;
    this.__valueAMin = this.__valueBMin = Infinity;
    this.__valueAMax = this.__valueBMax = -Infinity;
    this.__status = "";
