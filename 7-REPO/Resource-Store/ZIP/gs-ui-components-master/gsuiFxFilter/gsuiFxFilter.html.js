...
GSUI.setTemplate("gsui-fx-filter", () => [
  GSUI.createElement(
    "div",
    { class: "gsuiFxFilter-area gsuiFxFilter-areaType" },
    GSUI.createElement("span", { class: "gsuiFxFilter-area-label" }, "type"),
    GSUI.createElement(
      "div",
      { class: "gsuiFxFilter-area-content" },
      ...
      GSUI.getTemplate(
        "gsui-fx-filter-type",
        "lowshelf",
        "M 1 8 L 4 8 L 6 4 L 15 4"
      ),
      GSUI.getTemplate(
        "gsui-fx-filter-type",
        "highshelf",
        "M 1 4 L 10 4 L 12 8 L 15 8"
      ),
      GSUI.getTemplate(
        "gsui-fx-filter-type",
        "peaking",
        "M 1 8 L 7 8 L 8 4 L 9 8 L 15 8"
      ),
      GSUI.getTemplate(
        "gsui-fx-filter-type",
        "notch",
        "M 1 4 L 7 4 L 8 8 L 9 4 L 15 4"
      ),
  ...
  GSUI.createElement(
    "div",
    { class: "gsuiFxFilter-area gsuiFxFilter-areaGraph" },
    GSUI.createElement(
      "span",
      { class: "gsuiFxFilter-area-label" },
      "frequency"
    ),
  ...
  GSUI.createElement(
    "div",
    { class: "gsuiFxFilter-area gsuiFxFilter-areaFrequency" },
    GSUI.createElement(
      "div",
      { class: "gsuiFxFilter-area-content" },
  ...
  GSUI.createElement(
    "div",
    { class: "gsuiFxFilter-area gsuiFxFilter-areaGain" },
  ...
  GSUI.createElement(
    "div",
    { class: "gsuiFxFilter-area gsuiFxFilter-areaQ" },
  ...
  GSUI.createElement(
    "div",
    { class: "gsuiFxFilter-area gsuiFxFilter-areaDetune" },
...
GSUI.setTemplate("gsui-fx-filter-type", (type, d) =>
  GSUI.createElement(
    "button",
    { class: "gsuiFxFilter-areaType-btn", "data-type": type, title: type },
