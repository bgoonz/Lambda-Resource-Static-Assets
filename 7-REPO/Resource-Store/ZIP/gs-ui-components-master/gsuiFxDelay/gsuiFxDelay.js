...
class gsuiFxDelay {
  constructor() {
    ...
    this.gsdata = gsdata;
    this.oninput = this.onchange = GSUI.noop;
    ...
    uiSliderZoom.oninput = uiSliderZoom.onchange = this.zoom.bind(this);
    uiDotline.onchange = (echoes) =>
      this.gsdata.callAction("changeEchoes", echoes);
    uiDotline.oninput = (id, delay, pan) =>
      this.oninput("echoes", id, delay, pan);
  }
  ...
  _onclickLinkBtn() {
    const moveMode =
      this._uiDotline.options().moveMode === "free" ? "linked" : "free";
