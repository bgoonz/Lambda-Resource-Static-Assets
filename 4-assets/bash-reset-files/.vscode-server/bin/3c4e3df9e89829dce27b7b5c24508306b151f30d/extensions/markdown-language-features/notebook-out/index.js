!(function (e) {
  ...
  function (e, t, r) {
    "use strict";
    (e.exports.encode = r(13)),
      (e.exports.decode = r(14)),
      (e.exports.format = r(15)),
      (e.exports.parse = r(16));
  },
  function (e, t, r) {
    "use strict";
    var n =
  ...
  function (e, t, r) {
    ...
    const n = r(10);
    !(function () {
      const e = new n({ html: !0 });
      globalThis.extendMarkdownIt = (t) => {
        t(e);
      };
      acquireNotebookRendererApi(
        "notebookCoreTestRenderer"
      ).onDidCreateMarkdown(({ element: t, content: r }) => {
        const n = e.render(r);
        t.innerHTML = n;
      });
    })();
  ...
  function (e, t, r) {
    ...
    var n = r(0),
      ...
      l = r(5),
      p = r(68),
      h = { default: r(71), zero: r(72), commonmark: r(73) },
    ...
    (n.prototype.parse = function (e, t) {
      ...
      if (
        ...
        for (r = 0; r < l.length; r++)
          -1 !== (a = m.indexOf(l[r])) && (-1 === C || a < C) && (C = a);
        for (
          -1 !== (k = -1 === C ? m.lastIndexOf("@") : m.lastIndexOf("@", C)) &&
            ((b = m.slice(0, k)), (m = m.slice(k + 1)), (this.auth = b)),
            C = -1,
            r = 0;
          r < c.length;
          r++
        )
          -1 !== (a = m.indexOf(c[r])) && (-1 === C || a < C) && (C = a);
        -1 === C && (C = m.length), ":" === m[C - 1] && C--;
        var v = m.slice(0, C);
        (m = m.slice(C)),
          this.parseHost(v),
        ...
        if (!D) {
          ...
          for (r = 0, n = A.length; r < n; r++) {
            var y = A[r];
            if (y && !y.match(p)) {
              for (var x = "", F = 0, E = y.length; F < E; F++)
                y.charCodeAt(F) > 127 ? (x += "x") : (x += y[F]);
              if (!x.match(p)) {
                var w = A.slice(0, r),
                  q = A.slice(r + 1),
                  S = y.match(h);
                S && (w.push(S[1]), q.unshift(S[2])),
                  q.length && (m = q.join(".") + m),
  ...
  function (e, t, r) {
    "use strict";
    (t.parseLinkLabel = r(23)),
      (t.parseLinkDestination = r(24)),
      (t.parseLinkTitle = r(25));
  },
  function (e, t, r) {
    "use strict";
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r) {
      ...
      return (
        i === t ||
          0 !== o ||
          ((a.str = n(e.slice(i, t))), (a.lines = 0), (a.pos = t), (a.ok = !0)),
        a
      );
    };
  },
      ...
      for (t++, 40 === o && (o = 41); t < r; ) {
        if ((s = e.charCodeAt(t)) === o)
          return (
            (u.pos = t + 1),
            (u.lines = i),
            (u.str = n(e.slice(a + 1, t))),
            (u.ok = !0),
            u
          );
        if (40 === s && 41 === o) return u;
        10 === s
          ? i++
    ...
    (i.code_inline = function (e, t, r, n, s) {
      ...
      (i.fence = function (e, t, r, n, i) {
        var a,
          ...
          m = "";
        return (
          f && ((d = (c = f.split(/(\s+)/g))[0]), (m = c.slice(2).join(""))),
          0 ===
          (a =
            (r.highlight && r.highlight(h.content, d, m)) ||
      ...
      if (e.md.options.linkify)
        for (r = 0, o = v.length; r < o; r++)
          if ("inline" === v[r].type && e.md.linkify.pretest(v[r].content))
            for (m = 0, t = (i = v[r].children).length - 1; t >= 0; t--)
              if ("link_close" !== (u = i[t]).type) {
                if (
                  ("html_inline" === u.type &&
                    ((C = u.content),
                    /^<a[>\s]/i.test(C) && m > 0 && m--,
                    s(u.content) && m++),
                  !(m > 0) && "text" === u.type && e.md.linkify.test(u.content))
                ) {
                  for (
                    p = u.content,
                  ...
                  f < p.length &&
                    ...
                    (a.level = d),
                    c.push(a)),
                    (v[r].children = i = n(i, t, c));
                }
              } else
                for (t--; i[t].level !== u.level && "link_open" !== i[t].type; )
                  t--;
    };
  },
  function (e, t, r) {
      ...
      if (e.md.options.typographer)
        for (t = e.tokens.length - 1; t >= 0; t--)
          "inline" === e.tokens[t].type &&
            (s.test(e.tokens[t].content) && u(e.tokens[t].children),
            n.test(e.tokens[t].content) && c(e.tokens[t].children));
    };
  },
  function (e, t, r) {
    "use strict";
    var n = r(0).isWhiteSpace,
      s = r(0).isPunctChar,
      o = r(0).isMdAsciiPunct,
      i = /['"]/,
      a = /['"]/g;
    function u(e, t, r) {
    ...
    function c(e, t) {
      var r, i, c, l, p, h, f, d, m, g, _, b, k, C, v, D, A, y, x, F, E;
      for (x = [], r = 0; r < e.length; r++) {
        for (
          i = e[r], f = e[r].level, A = x.length - 1;
          A >= 0 && !(x[A].level <= f);
          A--
        );
        if (((x.length = A + 1), "text" === i.type)) {
          (p = 0), (h = (c = i.content).length);
          e: for (; p < h && ((a.lastIndex = p), (l = a.exec(c))); ) {
            if (
              ((v = D = !0),
              (p = l.index + 1),
              (y = "'" === l[0]),
            ...
            if (
              ((_ = o(m) || s(String.fromCharCode(m))),
              (b = o(g) || s(String.fromCharCode(g))),
              (k = n(m)),
              (C = n(g)) ? (v = !1) : b && (k || _ || (v = !1)),
              k ? (D = !1) : _ && (C || b || (D = !1)),
              34 === g && '"' === l[0] && m >= 48 && m <= 57 && (D = v = !1),
              v && D && ((v = _), (D = b)),
              v || D)
            ) {
              if (D)
                for (
                  A = x.length - 1;
                  A >= 0 && ((d = x[A]), !(x[A].level < f));
                  A--
                )
                  if (d.single === y && x[A].level === f) {
                    (d = x[A]),
                      y
                        ? ((F = t.md.options.quotes[2]),
                          (E = t.md.options.quotes[3]))
                        : ((F = t.md.options.quotes[0]),
                          (E = t.md.options.quotes[1])),
                      (i.content = u(i.content, l.index, E)),
                      (e[d.token].content = u(e[d.token].content, d.pos, F)),
                      (p += E.length - 1),
                      d.token === r && (p += F.length - 1),
                      (h = (c = i.content).length),
                      (x.length = A);
                    continue e;
                  }
              v
                ? x.push({ token: r, pos: l.index, single: y, level: f })
                : D && y && (i.content = u(i.content, l.index, "’"));
            } else y && (i.content = u(i.content, l.index, "’"));
          }
        }
      }
    }
  ...
  function (e, t, r) {
    ...
    var n = r(1),
      s = [
        ["table", r(36), ["paragraph", "reference"]],
        ["code", r(37)],
        ["fence", r(38), ["paragraph", "reference", "blockquote", "list"]],
        ["blockquote", r(39), ["paragraph", "reference", "blockquote", "list"]],
        ["hr", r(40), ["paragraph", "reference", "blockquote", "list"]],
        ["list", r(41), ["paragraph", "reference", "blockquote"]],
        ["reference", r(42)],
        ["heading", r(43), ["paragraph", "reference", "blockquote"]],
        ["lheading", r(44)],
        ["html_block", r(45), ["paragraph", "reference", "blockquote"]],
        ["paragraph", r(47)],
      ];
    function o() {
      this.ruler = new n();
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r, i) {
      var a, u, c, l, p, h, f, d, m, g, _, b, k, C, v, D;
      if (t + 2 > r) return !1;
      ...
      if (124 !== (a = e.src.charCodeAt(c++)) && 45 !== a && 58 !== a)
        return !1;
      for (; c < e.eMarks[h]; ) {
        if (124 !== (a = e.src.charCodeAt(c)) && 45 !== a && 58 !== a && !n(a))
          return !1;
        c++;
      }
      for (f = (u = s(e, t + 1)).split("|"), g = [], l = 0; l < f.length; l++) {
        if (!(_ = f[l].trim())) {
      ...
      if (-1 === (u = s(e, t).trim()).indexOf("|")) return !1;
      if (e.sCount[t] - e.blkIndent >= 4) return !1;
      if (
        ((f = o(u)).length && "" === f[0] && f.shift(),
        f.length && "" === f[f.length - 1] && f.pop(),
        0 === (d = f.length) || d !== g.length)
      )
        return !1;
      if (i) return !0;
      for (
        C = e.parentType,
          ...
          (m = e.push("table_open", "table", 1)).map = b = [t, 0],
        ...
        (m = e.push("th_open", "th", 1)),
          ...
          ((m = e.push("inline", "", 0)).content = f[l].trim()),
          (m.children = []),
      ...
      for (
        ...
        for (v = !1, l = 0, p = D.length; l < p; l++)
          if (D[l](e, h, r, !0)) {
            v = !0;
            break;
          }
        if (v) break;
        if (!(u = s(e, h).trim())) break;
        if (e.sCount[h] - e.blkIndent >= 4) break;
        for (
          (f = o(u)).length && "" === f[0] && f.shift(),
            f.length && "" === f[f.length - 1] && f.pop(),
            h === t + 2 &&
              ((m = e.push("tbody_open", "tbody", 1)).map = k = [t + 2, 0]),
            (m = e.push("tr_open", "tr", 1)).map = [h, h + 1],
            l = 0;
          l < d;
          l++
        )
          (m = e.push("td_open", "td", 1)),
            g[l] && (m.attrs = [["style", "text-align:" + g[l]]]),
            ((m = e.push("inline", "", 0)).content = f[l] ? f[l].trim() : ""),
            (m.children = []),
            (m = e.push("td_close", "td", -1));
        m = e.push("tr_close", "tr", -1);
      }
      return (
        k && ((m = e.push("tbody_close", "tbody", -1)), (k[1] = h)),
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r, n) {
      ...
      if (((u = h), (o = (h = e.skipChars(h, s)) - u) < 3)) return !1;
      if (
        ((l = e.src.slice(u, h)),
        (i = e.src.slice(h, f)),
      ...
      for (
        ...
        !(++a >= r) &&
        !(
          (h = u = e.bMarks[a] + e.tShift[a]) < (f = e.eMarks[a]) &&
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r, s) {
      ...
      for (
        u = f = e.sCount[t] + 1,
          32 === e.src.charCodeAt(F)
            ? (F++, u++, f++, (o = !1), (C = !0))
            : 9 === e.src.charCodeAt(F)
            ? ((C = !0),
              (e.bsCount[t] + f) % 4 == 3
                ? (F++, u++, f++, (o = !1))
                : (o = !0))
          ...
          d = [e.bMarks[t]],
          e.bMarks[t] = F;
        F < E && ((i = e.src.charCodeAt(F)), n(i));

      )
        9 === i ? (f += 4 - ((f + e.bsCount[t] + (o ? 1 : 0)) % 4)) : f++, F++;
      for (
        m = [e.bsCount[t]],
          e.bsCount[t] = e.sCount[t] + 1 + (C ? 1 : 0),
          l = F >= E,
          b = [e.sCount[t]],
          e.sCount[t] = f - u,
          k = [e.tShift[t]],
          ...
          h = t + 1;
        h < r &&
        ((y = e.sCount[h] < e.blkIndent),
        !((F = e.bMarks[h] + e.tShift[h]) >= (E = e.eMarks[h])));
        h++
      )
        if (62 !== e.src.charCodeAt(F++) || y) {
          if (l) break;
          for (v = !1, a = 0, c = D.length; a < c; a++)
            if (D[a](e, h, r, !0)) {
              v = !0;
              break;
            }
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r, s) {
      ...
      for (i = 1; c < l; ) {
        if ((a = e.src.charCodeAt(c++)) !== o && !n(a)) return !1;
        a === o && i++;
      }
      return (
        !(i < 3) &&
        (s ||
          ...
          (u.markup = Array(i + 1).join(String.fromCharCode(o)))),
        !0)
      );
    };
  },
    ...
    e.exports = function (e, t, r, n) {
      ...
      if (
        ...
        if (
          ((h = !0),
          (S = e.bMarks[t] + e.tShift[t]),
          (b = Number(e.src.substr(S, w - S - 1))),
          B && 1 !== b)
        )
          return !1;
      } else {
        if (!((w = s(e, t)) >= 0)) return !1;
        h = !1;
      }
      if (B && e.skipSpaces(w) >= e.eMarks[t]) return !1;
      if (((_ = e.src.charCodeAt(w - 1)), n)) return !0;
      for (
        g = e.tokens.length,
          h
        ...
        for (
          E = w,
            k = e.eMarks[C],
            p = v = e.sCount[C] + w - (e.bMarks[t] + e.tShift[t]);
          E < k;
        ...
        if (
          ((l = (a = E) >= k ? 1 : v - p) > 4 && (l = 1),
          (c = p + l),
          ((T = e.push("list_item_open", "li", 1)).markup =
          ...
          (e.sCount[t] = y),
          (e.tight = F),
          ((T = e.push("list_item_close", "li", -1)).markup =
            String.fromCharCode(_)),
          (C = t = e.line),
          (f[1] = C),
          (a = e.bMarks[t]),
        ...
        if (h) {
          if ((w = o(e, C)) < 0) break;
        } else if ((w = s(e, C)) < 0) break;
        if (_ !== e.src.charCodeAt(w - 1)) break;
      }
      return (
        ((T = h
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r, o) {
      ...
      for (
        c = e.lineMax,
          C = e.md.block.ruler.getRules("reference"),
          m = e.parentType,
      ...
      for (
        y = (b = e.getLines(t, x, e.blkIndent, !1).trim()).length, A = 1;
        A < y;
        A++
      ) {
        ...
        (10 === i || (92 === i && ++A < y && 10 === b.charCodeAt(A))) && D++;
      }
      if (d < 0 || 58 !== b.charCodeAt(d + 1)) return !1;
      for (A = d + 2; A < y; A++)
        if (10 === (i = b.charCodeAt(A))) D++;
        else if (!s(i)) break;
      if (!(g = e.md.helpers.parseLinkDestination(b, A, y)).ok) return !1;
      if (((l = e.md.normalizeLink(g.str)), !e.md.validateLink(l))) return !1;
      for (a = A = g.pos, u = D += g.lines, _ = A; A < y; A++)
        if (10 === (i = b.charCodeAt(A))) D++;
        else if (!s(i)) break;
      for (
        g = e.md.helpers.parseLinkTitle(b, A, y),
          A < y && _ !== A && g.ok
            ? ((v = g.str), (A = g.pos), (D += g.lines))
            : ((v = ""), (A = a), (D = u));
        A < y && ((i = b.charCodeAt(A)), s(i));

      )
        A++;
      if (A < y && 10 !== b.charCodeAt(A) && v)
        for (v = "", A = a, D = u; A < y && ((i = b.charCodeAt(A)), s(i)); )
          A++;
      return (
        !(A < y && 10 !== b.charCodeAt(A)) &&
        !!(f = n(b.slice(1, d))) &&
        (o ||
          (void 0 === e.env.references && (e.env.references = {}),
          void 0 === e.env.references[f] &&
            (e.env.references[f] = { title: v, href: l }),
          (e.parentType = m),
          (e.line = t + D + 1)),
        !0)
      );
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r, s) {
      ...
      for (i = 1, o = e.src.charCodeAt(++c); 35 === o && c < l && i <= 6; )
        i++, (o = e.src.charCodeAt(++c));
      return (
        !(i > 6 || (c < l && !n(o))) &&
        (s ||
          ((l = e.skipSpacesBack(l, c)),
          (a = e.skipCharsBack(l, 35, c)) > c &&
            n(e.src.charCodeAt(a - 1)) &&
            (l = a),
          (e.line = t + 1),
          ((u = e.push("heading_open", "h" + String(i), 1)).markup =
            "########".slice(0, i)),
          (u.map = [t, e.line]),
          ((u = e.push("inline", "", 0)).content = e.src.slice(c, l).trim()),
          (u.map = [t, e.line]),
          (u.children = []),
          ((u = e.push("heading_close", "h" + String(i), -1)).markup =
            "########".slice(0, i))),
        !0)
      );
    };
      ...
      for (
        ...
        if (!(e.sCount[f] - e.blkIndent > 3)) {
          if (
            ...
            (u = e.bMarks[f] + e.tShift[f]) < (c = e.eMarks[f]) &&
            (45 === (p = e.src.charCodeAt(u)) || 61 === p) &&
            ((u = e.skipChars(u, p)), (u = e.skipSpaces(u)) >= c)
          ) {
            l = 61 === p ? 1 : 2;
            break;
          }
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t, r, n) {
      ...
      for (u = e.src.slice(c, l), s = 0; s < o.length && !o[s][0].test(u); s++);
      if (s === o.length) return !1;
      if (n) return o[s][2];
      if (((i = t + 1), !o[s][1].test(u)))
        for (; i < r && !(e.sCount[i] < e.blkIndent); i++)
          if (
            ((c = e.bMarks[i] + e.tShift[i]),
            (l = e.eMarks[i]),
            (u = e.src.slice(c, l)),
            o[s][1].test(u))
          ) {
      ...
      (o.prototype.getLines = function (e, t, r, n) {
        ...
        for (l = new Array(t - e), o = 0; h < t; h++, o++) {
          for (
            i = 0,
              p = u = this.bMarks[h],
              c = h + 1 < t || n ? this.eMarks[h] + 1 : this.eMarks[h];
            u < c && i < r;

          ) {
            if (((a = this.src.charCodeAt(u)), s(a)))
          ...
          l[o] =
            i > r
              ? new Array(i - r + 1).join(" ") + this.src.slice(u, c)
              : this.src.slice(u, c);
        }
        return l.join("");
      }),
  ...
  function (e, t, r) {
    ...
    var n = r(1),
      s = [
        ...
        ["escape", r(52)],
        ["backticks", r(53)],
        ["strikethrough", r(7).tokenize],
        ["emphasis", r(8).tokenize],
        ["link", r(54)],
        ["image", r(55)],
        ["autolink", r(56)],
        ["html_inline", r(57)],
      ...
      o = [
        ["balance_pairs", r(59)],
        ["strikethrough", r(7).postProcess],
        ["emphasis", r(8).postProcess],
        ["text_collapse", r(60)],
      ];
    function i() {
      var e;
  ...
  function (e, t, r) {
    "use strict";
    for (var n = r(0).isSpace, s = [], o = 0; o < 256; o++) s.push(0);
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t) {
      ...
      if (
        ((u = (s = e.src.slice(r, l)).length),
        e.backticksScanned && (e.backticks[u] || 0) <= r)
      )
        return t || (e.pending += s), (e.pos += u), !0;
      ...
      return (e.backticksScanned = !0), t || (e.pending += s), (e.pos += u), !0;
    };
  },
  function (e, t, r) {
    "use strict";
    ...
    e.exports = function (e, t) {
      ...
      if (
        ((u = e.pos + 1), (a = e.md.helpers.parseLinkLabel(e, e.pos, !0)) < 0)
      )
        return !1;
      if ((c = a + 1) < m && 40 === e.src.charCodeAt(c)) {
        for (
          _ = !1, c++;
          c < m && ((o = e.src.charCodeAt(c)), s(o) || 10 === o);
          c++
        );
        if (c >= m) return !1;
        if (
        ...
        (c >= m || 41 !== e.src.charCodeAt(c)) && (_ = !0), c++;
      }
      if (_) {
        if (void 0 === e.env.references) return !1;
        if (
          (c < m && 91 === e.src.charCodeAt(c)
            ? ((g = c + 1),
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t) {
      ...
      if (
        ...
        return !1;
      if ((l = u + 1) < k && 40 === e.src.charCodeAt(l)) {
          ...
          ? ((o = e.md.normalizeLink(r)),
            !!e.md.validateLink(o) &&
              (t ||
                ...
                (i.markup = "autolink"),
                (i.info = "auto"),
                ((i = e.push("text", "", 0)).content =
                  e.md.normalizeLinkText(r)),
  ...
  function (e, t, r) {
    ...
    e.exports = function (e, t) {
      ...
      if (l + 1 < p)
        ...
        } else if ((c = e.src.slice(l).match(u)) && s(n, c[1]))
          ...
          for (
            ...
            if (
              ...
              (o.close || s.open) &&
                ...
                ((o.length % 3 == 0 && s.length % 3 == 0) || (u = !0)),
              !u)
            ) {
              (c = n > 0 && !t[n - 1].open ? t[n - 1].jump + 1 : 0),
                (s.jump = r - n + c),
                (s.open = !1),
                (o.end = r),
                (o.jump = c),
    ...
    (a.prototype.pushPending = function () {
      ...
      (a.prototype.scanDelims = function (e, t) {
        ...
        return (
          ...
          (h = s(n)) ? (m = !1) : f && (l || p || (m = !1)),
          l ? (g = !1) : p && (h || f || (g = !1)),
          t ? ((u = m), (c = g)) : ((u = m && (!g || p)), (c = g && (!m || f))),
          { can_open: u, can_close: c, length: a }
        );
      }),
      (a.prototype.Token = n),
      (e.exports = a);
  ...
  function (e, t, r) {
    ...
    e.exports = function (e) {
      var t = {};
      (t.src_Any = r(64).source),
        (t.src_Cc = r(65).source),
        (t.src_Z = r(66).source),
        (t.src_P = r(67).source),
  ...
  function (e, t, r) {
    (function (e, n) {
      ...
      /*! https://mths.be/punycode v1.4.1 by @mathias */ !(function (o) {
        ...
        function v(e, t, r) {
          var n = 0;
          for (e = r ? f(e / 700) : e >> 1, e += f(e / t); e > 455; n += 36)
            e = f(e / 35);
        ...
        function D(e) {
          ...
          for ((r = e.lastIndexOf("-")) < 0 && (r = 0), n = 0; n < r; ++n)
            e.charCodeAt(n) >= 128 && m("not-basic"), d.push(e.charCodeAt(n));
          for (s = r > 0 ? r + 1 : 0; s < g; ) {
            for (
              o = _, i = 1, a = 36;
              s >= g && m("invalid-input"),
                ((c =
                  ...
                  m("overflow"),
                (_ += c * i),
                !(c < (l = a <= C ? 1 : a >= C + 26 ? 26 : a - C));
              a += 36
            )
              i > f(u / (p = 36 - l)) && m("overflow"), (i *= p);
            (C = v(_ - o, (t = d.length + 1), 0 == o)),
              f(_ / t) > u - b && m("overflow"),
              (b += f(_ / t)),
              (_ %= t),
              d.splice(_++, 0, b);
          }
        ...
        function A(e) {
          var t,
            ...
            D,
            A = [];
          for (g = (e = b(e)).length, t = 128, r = 0, o = 72, i = 0; i < g; ++i)
            (h = e[i]) < 128 && A.push(d(h));
          for (n = s = A.length, s && A.push("-"); n < g; ) {
            for (a = u, i = 0; i < g; ++i) (h = e[i]) >= t && h < a && (a = h);
            for (
              a - t > f((u - r) / (_ = n + 1)) && m("overflow"),
                r += (a - t) * _,
                t = a,
                i = 0;
              i < g;
              ...
              if (((h = e[i]) < t && ++r > u && m("overflow"), h == t)) {
                for (
                  c = r, l = 36;
                  !(c < (p = l <= o ? 1 : l >= o + 26 ? 26 : l - o));
                  l += 36
                )
                  (D = c - p),
                    (k = 36 - p),
                    A.push(d(C(p + (D % k), 0))),
                    (c = f(D / k));
                A.push(d(C(c, 0))), (o = v(r, _, n == s)), (r = 0), ++n;
              }
            ++r, ++t;
          }
          return A.join("");
